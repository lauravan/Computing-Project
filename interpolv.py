...
#utilise a matrix formulation to find the energies of the bands
    ...
    #indexes the coordinates within the matrix
            ...
            if deltag.dot(deltag) == 3 and mags(gs[i]) != 0:
                energy += (V[0] * strucfact(deltag)) * (-1.7320508075688772/(mags(gs[i])*5)  )
                # print(mags(gs[i]))

            if deltag.dot(deltag) == 4 and mags(gs[i]) != 0:
                energy += (V[1] * strucfact(deltag)) * (-1.7320508075688772/(mags(gs[i])**5)  )
            
            if deltag.dot(deltag) == 8 and mags(gs[i]) != 0:
                energy += (V[2] * strucfact(deltag)) * (-1.7320508075688772/(mags(gs[i])**5)  ) 

            if deltag.dot(deltag) == 11 and mags(gs[i]) != 0:
                energy += (V[3] * strucfact(deltag)) * (-1.7320508075688772/(mags(gs[i])**5)  )       
...
# print(matrix(3,'fcc', numpy.array([1,0,0]), ffg))
############################################################
...
# print(eigenvalues(3,'fcc', numpy.array([1,0,0]), ffg))
